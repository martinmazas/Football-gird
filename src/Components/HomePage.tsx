...
export default function HomePage() {
  ...
  // Keep the ad always mounted (same component instance)
  const belowAd = useMemo(() => <BelowGameAd tournament={"HOME"} />, []);

  return (
    <>
      {openModal ? (
        <>
          {/* Full screen instructions (nothing visible behind) */}
          <InstructionsCard setOpenModal={setOpenModal} />

          {/* ✅ Off-screen ad "warm up": not visible, but renderable */}
          <div
            style={{
              position: "fixed",
              left: "-10000px",
              top: 0,
              width: "728px", // give it a real layout box
              height: "250px", // enough for 300x250 if you enabled it
              overflow: "hidden",
            }}
            aria-hidden="true"
          >
        ...
        >
          ...
          >
            ...
            >
              {/* Now it's on-screen (already loaded or loading) */}
              {belowAd}
              ...
              >
                ...
                >
                  Select a competition and dive into the grid. Every pick
